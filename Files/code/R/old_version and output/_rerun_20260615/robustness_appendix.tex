...
DI channel relevance (joint Wald; marginal effect vs.\ $S$) & Whether the two DI terms are jointly relevant, and how to read them under collinearity & Jointly significant (Wald $F{=}4.23$, $p{=}0.022$), so retained; level and interaction \emph{not} separately identified ($r{=}0.96$; $158/418$ nonzero-DI quarters). Only the marginal effect is interpretable: $\partial y/\partial F^{DI}_{i,k-1}={+}1.47$ (95\% CI $[0.36,2.59]$) at $S{=}0$, indistinguishable from $0$ at $S\geq 37$ (zero-crossing $S^{\star}\approx 36$); unconditional DI insignificant ($-0.62$, $p{=}0.15$). \\
\addlinespace
