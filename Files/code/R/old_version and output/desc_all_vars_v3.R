...
# Full range: Q3.2019 for debt lag, Q4.2019-Q2.2022 for estimation
...
# --- Debt first difference (chronological) ---
df <- df %>%
  mutate(
...
# --- Estimation sample: Q4.2019 - Q2.2022 (11 quarters) ---
