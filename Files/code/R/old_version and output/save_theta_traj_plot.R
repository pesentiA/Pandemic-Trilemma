...
# Aggregate to OECD mean per week
...
ggsave(
  filename = file.path(safeplots, "theta_excess_stringency_trajectory.pdf"),
  plot     = p_theta_traj,
  width    = 18, height = 10, units = "cm"
)

ggsave(
  filename = file.path(safeplots, "theta_excess_stringency_trajectory.png"),
  plot     = p_theta_traj,
  width    = 18, height = 10, units = "cm", dpi = 300
)

cat("Saved: theta_excess_stringency_trajectory.pdf/.png\n")
