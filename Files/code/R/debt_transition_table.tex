...
$y_{i,k-1}$ \,($-\gamma_y$) & $-0.120***$ & $-0.116***$ & $-0.116***$ & $-0.116***$ \\
...
$F^{CP,\,\text{below}}_{ik}$ \, (aggregate flow) & $0.586***$ &  &  &  \\
 & (0.114) &  &  &  \\[4pt]
$F^{CP,\,\text{loans}}_{ik}$ \, (headline) &  & $0.503***$ &  &  \\
 &  & (0.096) &  &  \\[4pt]
$F^{CP,\,\text{guar}}_{ik}$ \, (headline) &  & $0.135*$ &  &  \\
 &  & (0.071) &  &  \\[4pt]
$F^{CP,\,\text{loans}}_{ik}$ \, (low take-up) &  &  & $1.258***$ &  \\
 &  &  & (0.240) &  \\[4pt]
$F^{CP,\,\text{guar}}_{ik}$ \, (low take-up) &  &  & $0.538*$ & $0.538*$ \\
 &  &  & (0.285) & (0.285) \\[4pt]
$F^{CP,\,\text{loans}}_{ik}$ \, (mid take-up) &  &  &  & $0.838***$ \\
 &  &  &  & (0.160) \\[4pt]
$F^{CP,\,\text{guar}}_{ik}$ \, (preferred take-up) &  &  & $0.538*$ & $0.538*$ \\
 &  &  & (0.285) & (0.285) \\[4pt]
