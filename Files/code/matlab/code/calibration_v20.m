...
figure('Name','Calibration V20','Color','w','Position',[50 50 1300 700]);
...
ylabel('% 2019 GDP'); title('Debt Level');
legend('','','Sim','Obs','Location','SE');
...
ylabel('infection (share of population)'); title('\theta: Sim vs Obs (wave adjusted)');
...
grid on;
set(gca, 'XTick', 1:K_theta, 'XTickLabel', qlbl(1:K_theta), 'XTickLabelRotation', 45);
ylabel('deaths/10^6/week'); title('d: Sim vs Obs (wave adjusted)');
legend('','','Sim','Obs','Location','NE');

sgtitle('Calibration - Pandemic Trilemma (y, b, \theta, d) Cross-Country Median Trajectory');
...
figure('Name','Debt change V21','Color','w','Position',[80 80 700 420]);
hold on;
