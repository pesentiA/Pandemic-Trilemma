...
tol_inner      = 1e-5;    % Inner loop convergence tolerance
tol_outer      = 1e-4;    % Outer loop constraint tolerance
phi_penalty    = 2.0;     % Penalty scaling factor
...
c_bounds = [0; 1; 0; 0.2; 0; 0.2]; % The offset constants
...
for outer_iter = 1:max_outer_iter
    ...
    for inner_iter = 1:max_inner_iter
        ...
        for k = N:-1:1
            ...
            % --- FIX: Correct sign for affine update & no clamping ---
