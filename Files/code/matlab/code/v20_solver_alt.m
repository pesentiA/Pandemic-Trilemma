...
P.c_lo=0.6; %0.4 als Alternative-> IMF DATA
P.c_gu=0.25;  %Gleiche Quelle
P.r=0.001;
P.gamma_y=0.117;
P.k_ab=0.664;
P.k_lo=0.836;
...
tau   = 0.02; %Parameter um zu drehen
...
W.lam_d = 14.63;          % lam_d = freier Relativgewicht-Parameter (Sweep)
...
W.p_S = 0.0; % [0.005-0.02]
W.p_F = 0.0; %[0.02, 0.1] %/var(allF,1)
