...
P.decay_K  = 0.1;
P.phi_S=0.5;
ifr=[0.005 0.011 0.005 0.004 0.0025 0.00028];  %[0.008 0.005 0.004 0.003 0.002 0.0002]-> from data with lo
...
C.b0 = mean(b0_val); C.mu_y = mean(cfe_y_val); C.mu_b = mean(cfe_b_val); %mean(cfe_b_val)
