...
P.decay_K  = 0.10;        % below-the-line stock depreciation per quarter
P.phi_S=0.314;
...
% Post-vax regime (rho_theta_post = last entry of rho_th_q, decay_K),
% omicron-era delta_theta, no time trend, no shocks.
    A = zeros(P.n); B = zeros(P.n, P.m);
    A(1,1)=P.rho_y; A(1,4)=-P.beta_d; A(1,6)=P.alpha_above;
